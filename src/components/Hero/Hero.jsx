  ...
  return (
    <section className={styles.container}>
      <div className={styles.content}>
        <h1 className={styles.title}>Waqar Ali Khan</h1>
        <p className={styles.description}>
          As an lead electrical engineer with 16 years of experience in design
          and installation, I am passionate about integrating cutting-edge
        ...
        <a href="mailto:waqarkhtk@gmail.com" className={styles.contactBtn}>
          Contact Me
        </a>
      </div>
      <img
